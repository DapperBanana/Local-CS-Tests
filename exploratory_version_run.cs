...
class Program
{
    ...
    static int choice; // Player's choice
    static int flag = 0; // Checks for a win

    static void Main()
    {
        do
        {
            Console.Clear(); // Whenever loop will start, screen will be cleared
            ...
            // Check if the selected position is already filled, if yes then ask to select some other field
